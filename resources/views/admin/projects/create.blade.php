...
<div class="max-w-3xl bg-white border border-slate-200 rounded-3xl shadow-sm p-8">
    <div class="mb-6 flex items-center justify-between">
        <h2 class="text-sm font-bold text-slate-500 uppercase tracking-widest">New Project Form</h2>
    ...
    <form action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div>
            ...
            <textarea 
                ...
                rows="5" 
                required 
                placeholder="Detailed summary of the project..."
                class="w-full px-4 py-2.5 border border-slate-300 rounded-lg text-sm focus:ring-indigo-500 focus:border-indigo-500"
        ...
        <div>
            ...
            <input 
                ...
                value="{{ old('tech_stack_input') }}" 
                required 
                placeholder="e.g. Laravel, Vue.js, MySQL, Bootstrap 5"
                class="w-full px-4 py-2.5 border border-slate-300 rounded-lg text-sm focus:ring-indigo-500 focus:border-indigo-500"
            />
